    ...
    return (
        <div className="p-6 rounded-md border border-white/10 bg-white/5 backdrop-blur-xl">
            ...
            <button
                ...
                disabled={saving}
                className="mt-5 w-full flex items-center justify-center gap-2 px-5 py-3 rounded-lg bg-blue-500/20 border border-blue-500/40 text-blue-300 text-sm font-mono hover:bg-blue-500/30 transition-all cursor-pointer disabled:opacity-60"
            >
            ...
            <button
                onClick={onLogout}
                className="mt-4 w-full flex items-center justify-center gap-2 px-5 py-3 rounded-lg border border-red-500/30 bg-red-500/10 text-red-400 text-sm font-mono hover:bg-red-500/20 transition-all cursor-pointer"
            >
                Sign Out
            </button>
        </div>
