...
export default function RefundDialog({ isOpen, onClose, amount }) {
                    ...
                    >
                        ...
                        <div className="relative z-10 text-center">
                            ...
                            <p className="text-xs font-mono text-gray-400 leading-relaxed mb-2">
                                The refunded amount has been added to your
                                SNEAKET wallet.
                            </p>
                            ...
                            <button
                                onClick={onClose}
                                className="group relative w-full mt-6 overflow-hidden px-4 py-3 text-xs font-mono transition-all duration-500 hover:scale-[1.02] cursor-pointer bg-green-500/30 border border-green-500/40 text-white hover:bg-green-500/40"
                            >
